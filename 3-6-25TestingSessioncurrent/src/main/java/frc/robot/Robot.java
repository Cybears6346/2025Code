...
public class Robot extends TimedRobot {
  ...
  public void getSelected1()
  {
    ...
    SmartDashboard.putString("Currently selected auto", A_Selected);
  }
  ...
  public void autonomousInit(){
    ...
    // AutoSub.scoreL2Auto2(DriveSub, ElevatorSub, ArmController);
    // stopAll();
    // getSelected1();
    // SmartDashboard.putString("Auto Command", "zeroWinch"); Ignore the winch and arm commands
  ...
  public void RunAuto(){
    if (AutoFinished == false){
        switch (A_Selected) {
          //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
          case A_Stationary:
            AutonomousSub.doNothingAuto(DriveSub);
